#!/usr/bin/env python3
"""
Simple test version of the IoT Device Data Generator Panel
"""
...
class TestDevicePanel:
    def __init__(self):
        self.root = ctk.CTk()
        self.root.title("IoT Device Data Generator - Test")
    ...
    def generate_custom_data(self):
        ...
        try:
            ...
            self.log_message(f"📊 Generated custom data for Device {self.device_id}")
            self.log_message(f"📊 T={temperature}°C, SM={soil_moisture}%, L={light_level}lux, WT={watertank_level}%")
    ...
    def generate_random_data(self):
        ...
        self.log_message(f"🎲 Generated random data for Device {self.device_id}")
        self.log_message(f"📊 T={temperature}°C, SM={soil_moisture}%, L={light_level}lux, WT={watertank_level}%")
        self.log_message(f"📄 Data: {json.dumps(data, indent=2)}")
